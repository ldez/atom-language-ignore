describe 'Should parse a "file" line when', ->
  ...
  it 'contains a description with extension and rangge', ->
    ...
    expect(tokens[2]).toEqual value: 'a-b', scopes: ['text.ignore', 'line.file.ignore', 'keyword.file.content.ignore', 'range.ignore', 'constant.other.symbol.range.content.ignore']
    expect(tokens[3]).toEqual value: ']', scopes: ['text.ignore', 'line.file.ignore', 'keyword.file.content.ignore', 'range.ignore', 'constant.other.symbol.range.end.ignore']
  ...
  it 'contains a description with extension and rangge and restiction', ->
    ...
    expect(tokens[0]).toEqual value: '/', scopes: ['text.ignore', 'line.file.ignore', 'constant.restriced.file.ignore']
    expect(tokens[1]).toEqual value: 'file', scopes: ['text.ignore', 'line.file.ignore', 'keyword.file.content.ignore']
    expect(tokens[2]).toEqual value: '[', scopes: ['text.ignore', 'line.file.ignore', 'keyword.file.content.ignore', 'range.ignore', 'constant.other.symbol.range.begin.ignore']
    expect(tokens[3]).toEqual value: 'a-b', scopes: ['text.ignore', 'line.file.ignore', 'keyword.file.content.ignore', 'range.ignore', 'constant.other.symbol.range.content.ignore']
    expect(tokens[4]).toEqual value: ']', scopes: ['text.ignore', 'line.file.ignore', 'keyword.file.content.ignore', 'range.ignore', 'constant.other.symbol.range.end.ignore']
  ...
  it 'contains a description without extension and with sub-directory and restiction', ->
    ...
    expect(tokens[2]).toEqual value: '/', scopes: [ 'text.ignore', 'line.file.ignore', 'keyword.file.content.ignore', 'constant.separator.directory.ignore']
  ...
  it 'contains a description with extension and with sub-directory and restiction', ->
    ...
    expect(tokens[1]).toEqual value: 'directory', scopes: [ 'text.ignore', 'line.file.ignore', 'keyword.file.content.ignore']
    expect(tokens[2]).toEqual value: '/', scopes: [ 'text.ignore', 'line.file.ignore', 'keyword.file.content.ignore', 'constant.separator.directory.ignore']
    expect(tokens[3]).toEqual value: 'file.txt', scopes: ['text.ignore', 'line.file.ignore', 'keyword.file.content.ignore']
